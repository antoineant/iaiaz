...
interface FamiliaChatClientProps {
  userName: string;
...
export function FamiliaChatClient({
  userName,
  creditBalance,
  accentColor,
  ...
  conversations,
  supervisionMode,
}: FamiliaChatClientProps) {
  const t = useTranslations("familia.chat");
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-accent-50 dark:from-[var(--background)] dark:to-primary-950">
      ...
      <div className="max-w-4xl mx-auto px-4 py-6">
        {/* Assistants Section */}
        <h2 className="text-lg font-semibold mb-4">{t("myAssistants")}</h2>

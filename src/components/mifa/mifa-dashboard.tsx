...
export function MifaDashboard({
  ...
  const t = useTranslations("mifa.dashboard");
            ...
            <div className="space-y-3">
              ...
              return (
                <Card
                  ...
                  onClick={() => router.push({ pathname: "/mifa/dashboard/[childId]", params: { childId: member.user_id } })}
                >

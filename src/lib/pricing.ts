...
export const MODEL_PRICING = {
  ...
  "gpt-5.4": {
    ...
    input: 2.50,
    output: 15.0,
    description: "Le plus intelligent d'OpenAI. Idéal pour le raisonnement complexe et le code.",
    recommended: false,
    category: "premium",
    capabilities: { images: true, pdf: true },
  },
  "gpt-5.4-mini": {
    ...
    input: 0.75,
    output: 4.50,
    description: "Mini puissant d'OpenAI. Excellent rapport qualité/prix pour le code.",
    recommended: false,
    category: "balanced",
    capabilities: { images: true, pdf: true },
  },
  "gpt-5.4-nano": {
    ...
    input: 0.20,
    output: 1.25,
    description: "Ultra économique. Parfait pour les tâches simples en volume.",
    recommended: false,
    category: "economy",
